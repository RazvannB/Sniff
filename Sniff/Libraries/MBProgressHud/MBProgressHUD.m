...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    hud.labelColor = [UIColor colorWithRed:33/255.0 green:66/255.0 blue:100/255.0 alpha:1];
    hud.activityIndicatorColor = [UIColor colorWithRed:33/255.0 green:66/255.0 blue:100/255.0 alpha:1];
    hud.color = [UIColor colorWithWhite:0.8 alpha:1];
